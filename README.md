...
# 招聘平台系统 (Recruit System)

#### 介绍

这是一个基于 SpringBoot + Vue + ElementUI 开发的全栈招聘平台系统。系统为招聘者和求职者提供功能齐全、方便快捷的招聘求职服务。
...
**用户角色：**
- **求职者**：浏览职位、收藏职位、投递简历、查看投递状态、面试安排
- **招聘者(HR)**：发布职位、查看投递简历、筛选简历、预约面试
- **管理员**：管理职位分类、审核企业信息、权限管理
